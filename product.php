//htdocs\opencart2\admin\model\catalog\product.php 
<?php
class ModelCatalogProduct extends Model {
  ...
  public function getimage($data) {    
    $this->db->query("INSERT INTO " . DB_PREFIX . "image SET name = '" . $this->db->escape($data['name']) . "', dir = '" . $this->db->escape($data['dir']) . "'");
  }
